...
|-----|-----|-----|-----|-----|
|[Portal_Pwn](https://github.com/OSINTI4L/DuckyScript-Payloads/tree/main/Payloads/Portal_Pwn)|WiFi Pineapple Pager|`Network`|Offensive-Prank|Portal Pwn is a payload allowing an attacker to spam or crash ESP32 Marauder evil portals.

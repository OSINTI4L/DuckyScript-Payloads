...
|[MOAA](https://github.com/OSINTI4L/DuckyScript-Payloads/tree/main/Payloads/MOAA)|`Linux`|Prank|The Mother Of All Annoyances. Quite possibly the most annoying payload to have ever been created (see payload comments).

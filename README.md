...
|[MOAA](https://github.com/OSINTI4L/DuckyScript-Payloads/blob/main/Payloads/MOAA/payload.txt)|`Linux`|Prank|The Mother Of All Annoyances. Quite possibly the most annoying payload to have ever been created (see payload comments).
